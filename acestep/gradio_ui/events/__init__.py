...
def setup_training_event_handlers(demo, dit_handler, llm_handler, training_section):
    ...
    def training_wrapper(tensor_dir, r, a, d, lr, ep, bs, ga, se, sh, sd, od, rf, ts):
        try:
            for progress, log, plot, state in train_h.start_training(
                tensor_dir, dit_handler, r, a, d, lr, ep, bs, ga, se, sh, sd, od, rf, ts
            ):
    ...
    training_section["start_training_btn"].click(
        ...
        inputs=[
            ...
            training_section["resume_checkpoint"],
    ...
    training_section["refresh_checkpoints_btn"].click(
        fn=train_h.list_checkpoints,
        inputs=[training_section["lora_output_dir"]],
        outputs=[training_section["resume_checkpoint"]],
    )
